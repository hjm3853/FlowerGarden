...
{
	[Serializable]
	public class MonsterTable_Server : EERowData
	{
		[EEKeyField]
		[SerializeField]
		private long _UID;
		...
		public MonsterTable_Server()
		{
		}

#if UNITY_EDITOR
		public MonsterTable_Server(List<List<string>> sheet, int row, int column)
		{
	...
	public class MonsterTable_MonsterTable_Server : EERowDataCollection
	{
		
		public List<MonsterTable_Server> elements = new List<MonsterTable_Server>();

		public override void AddData(EERowData data)
		{
			elements.Add(data as MonsterTable_Server);
		}
