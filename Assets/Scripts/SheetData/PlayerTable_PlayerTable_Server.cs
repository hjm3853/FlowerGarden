...
{
	[Serializable]
	public class PlayerTable_Server : EERowData
	{
		[EEKeyField]
		[SerializeField]
		private long _UID;
		...
		public PlayerTable_Server()
		{
		}

#if UNITY_EDITOR
		public PlayerTable_Server(List<List<string>> sheet, int row, int column)
		{
	...
	public class PlayerTable_PlayerTable_Server : EERowDataCollection
	{
		
		public List<PlayerTable_Server> elements = new List<PlayerTable_Server>();

		public override void AddData(EERowData data)
		{
			elements.Add(data as PlayerTable_Server);
		}
