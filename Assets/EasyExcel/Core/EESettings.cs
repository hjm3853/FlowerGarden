...
namespace EasyExcel
{
	...
	public class EESettings : ScriptableObject
	{
		...
		[SerializeField]
		private string generatedClientClientAssetPath;
		[SerializeField]
		private string generatedServerAssetPath;
		...
		public string GeneratedClientAssetPath
		{
			get { return generatedClientClientAssetPath; }
			set
			{
				if (generatedClientClientAssetPath == value)
					return;
				generatedClientClientAssetPath = value;
				modified = true;
			}
		}
		public string GeneratedServerAssetPath
		{
			get { return generatedServerAssetPath; }
			set
			{
				if (generatedServerAssetPath == value)
					return;
				generatedServerAssetPath = value;
				modified = true;
			}
		}
